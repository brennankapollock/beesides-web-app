...
import { SearchIcon, ArrowRightIcon, CheckIcon, XIcon, PlayIcon, StarIcon, ListMusicIcon, UserIcon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 pt-6 pb-20 md:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register" className="px-8 py-3 bg-black text-white rounded-lg hover:bg-gray-900 transition-colors font-bold text-center">
              Join Now
            </Link>
            <Link to="/discover" className="px-8 py-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              Explore Music
            </Link>
          </div>
        </div>
          ...
          <div className="md:flex items-center gap-12">
            ...
            <div className="md:w-1/2 bg-gray-50 p-8 rounded-2xl">
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?q=80&w=2070&auto=format&fit=crop" alt="People discussing music" className="rounded-lg w-full" />
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg max-w-xs">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-200 flex-shrink-0 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1964&auto=format&fit=crop" alt="User" className="w-full h-full object-cover" />
                    </div>
                    <div>
              ...
              <div className="relative">
                <div className="bg-white rounded-xl shadow-lg p-5">
                  <div className="flex gap-4 mb-4">
                    <img src="https://images.unsplash.com/photo-1599719500956-d158a3abd461?q=80&w=2070&auto=format&fit=crop" alt="Album cover" className="w-20 h-20 rounded-lg object-cover" />
                    <div>
                      <h3 className="font-bold">The Suffering</h3>
                      <p className="text-sm opacity-70">Emily Bryan</p>
                      <div className="flex items-center mt-1">
                        <div className="flex">
                          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(star => <StarIcon key={star} size={14} className="fill-black" />)}
            ...
            <div className="md:w-1/2 bg-gray-50 p-8 rounded-2xl">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[1, 2, 3].map(i => <div key={i} className="bg-white p-3 rounded-lg">
                      <div className="w-12 h-12 rounded-full bg-gray-200 mx-auto mb-2 overflow-hidden">
                        <img src={`https://images.unsplash.com/photo-${1500648767791 + i}-00173eea3a1e?q=80&w=1974&auto=format&fit=crop`} alt={`Curator ${i}`} className="w-full h-full object-cover" />
                      </div>
                ...
                <div className="bg-white p-3 rounded-lg">
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2">
                    {[1, 2, 3, 4].map(i => <img key={i} src={albums[i - 1].cover} alt={`Album ${i}`} className="w-12 h-12 rounded object-cover flex-shrink-0" />)}
        ...
        <div className="mb-32">
          ...
          <div className="relative bg-gray-50 rounded-2xl p-8 md:p-12 overflow-hidden">
            <div className="md:w-3/4 mx-auto">
              <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=1974&auto=format&fit=crop" alt="App interface" className="rounded-xl shadow-2xl" />
              {/* Feature Callouts */}
        ...
        <div className="mb-32">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {comparisonFeatures.map((feature, index) => <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : ''}>
                    <td className="p-4 font-medium">{feature.name}</td>
                    <td className="p-4 text-center">
                      {feature.beesides ? <CheckIcon size={24} className="mx-auto text-green-600" /> : <XIcon size={24} className="mx-auto text-red-500" />}
                    </td>
                    <td className="p-4 text-center">
                      {feature.streaming ? <CheckIcon size={24} className="mx-auto text-green-600" /> : <XIcon size={24} className="mx-auto text-red-500" />}
                    </td>
                  </tr>)}
              </tbody>
            </table>
                ...
                <form className="bg-white p-6 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="text" id="name" placeholder="Your name" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black text-black" />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm text-gray-700 mb-1">
                        Email
                      </label>
                      <input type="email" id="email" placeholder="you@example.com" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black text-black" />
                    </div>
        ...
        <div className="text-center max-w-xl mx-auto py-12">
          ...
          <Link to="/register" className="inline-block px-8 py-3 bg-black text-white rounded-lg hover:bg-gray-900 transition-colors font-bold text-center">
            Join Beesides Now
          </Link>
        </div>
      </div>
